...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='/home/lcur1547/dl_code/Repo/input_New/Imgs_CF_new/mask')
    ...
    parser.add_argument('--save_dir', type=str, default='./test/gans_kl_term_temp_l1_both')
