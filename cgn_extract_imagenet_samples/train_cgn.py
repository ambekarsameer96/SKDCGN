...
from cgn_extract_imagenet_samples.config import get_cfg_defaults
...
def fit(cfg, cgn, opts, losses):
    ...
    if cfg.WEIGHTS_PATH:
        ...
        model_path = join('cgn_extract_imagenet_samples', 'experiments',
    ...
    # fixed noise sample
    u_fixed_path = join('cgn_extract_imagenet_samples', 'experiments', 'u_fixed.pt')
